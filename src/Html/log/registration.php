...
<div class="container">
    <div class="row mt-5 justify-content-md-center">
        <div class="col-6">
            ...
            <?php echo $form->start(); ?>
            <?php echo(new \Core\FormBuilder\Label('Name', ['for' => 'name', 'class' => 'form-label'])); ?>
            <?php echo (new \Core\FormBuilder\Input('name', 'text', ['id' => 'name', 'class' => "form-control mb-3"]))->required(); ?>
